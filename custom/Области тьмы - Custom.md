...
![image](https://github.com/OboyaShka/frontendLectures/assets/66056854/20197d98-6703-4f3e-b4c9-9e711a6f293a)
...
![image](https://github.com/OboyaShka/frontendLectures/assets/66056854/3632180f-7f06-449e-8e5b-cc3d270487fa)
...
GlobalExectionContext = {
    ...
    VariableEnvironment: {
        EnvironmentRecord: {
            a: undefined
            foo: < func (FooFunctionExectionContext) > // При вызове создастся новый контекст, который добавится в стек
        }
...
![ciDH8ypprL8](https://github.com/OboyaShka/frontendLectures/assets/66056854/9410967b-f4b9-4e83-9a48-c3414e72097c)
...
![hehe](https://github.com/OboyaShka/frontendLectures/assets/66056854/d0c464b7-05ce-452e-b321-b808a2fc5b41)
...
![image](https://github.com/OboyaShka/frontendLectures/assets/66056854/7835dc79-e5d3-4bf7-9da1-c72cc10b21fd)
...
![image](https://github.com/OboyaShka/frontendLectures/assets/66056854/5d60e241-38cc-4fa2-a6dd-ab21a45e20e6)

Кратко по тому, что мы прошли
- Существует абстрактный механизм контекст выполнения, нужный для отслеживания хода выполнения кода. 
- Контекст бывает глобальный и контекст выполнения функции. При вложенном вызове контексты образуют LIFO-стек.
- Лексическое окружение, структура данных содержащая связь идентификаторов переменных со значениями.
- Область видимости, совокупность лексических окружений для конкретного места в программе.
- При создании контекста происходит привязка bind и определение ScopeChain. 
- this является свойством контекста и определяется в зависимости от различных факторов.
- ScopeChain свойство контекста, которой определяется из [[SCOPES]] функции с добавлением лексического окружения.
- Поиск идентификатора происходит с помощью ScopeChain.
- [[SCOPES]] определяется в момент создания функции и замыкает в себе совокупность лексических окружений предыдущих контекстов.
- Из-за того, что [[SCOPES]] определяется в момент создания, если из функции вернуть функцию, то она замкнёт в себе лексическое окружение вышестоящей функции.
